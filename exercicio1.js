...
class CentroTreinamento {
    ...
    //     }
        ...
        // return `O IMC desse membro é: ${this.peso / Math.pow(this.altura, 2)}`;
    }
}
...
// console.log(centroTreinamento.receberDescontoEspecial());
// console.log(centroTreinamento.calcularIMC());
